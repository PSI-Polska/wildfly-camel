...
include::camel-elasticsearch-rest.adoc[]
...
include::camel-micrometer.adoc[]

include::camel-microprofile-health.adoc[]

include::camel-microprofile-metrics.adoc[]

include::camel-milo.adoc[]

include::camel-mina.adoc[]
...
include::camel-wordpress.adoc[]

include::camel-xchange.adoc[]
